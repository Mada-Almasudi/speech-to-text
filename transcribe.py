...
authenticator = IAMAuthenticator('ve9vdVgPhKwD9jI2v2M5Cd3f-o38WptkHf0z2auKZlvK')
tts = TextToSpeechV1( authenticator=authenticator)

tts.set_service_url('https://api.us-south.speech-to-text.watson.cloud.ibm.com/instances/bb001457-e6bb-4d0d-b881-8b8ca0acbc42')
...
def on_close(ws):
    """Upon close, print the complete and final transcr ipt."""
    global LAST
    if LAST:
        FINALS.append(LAST)
